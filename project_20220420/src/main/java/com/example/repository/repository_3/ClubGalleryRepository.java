...
public interface ClubGalleryRepository extends JpaRepository<ClubGallery, Long>{
	...
	List<ClubGallery> findByCgnameAndClub_cnoContainingOrderByCgnoDesc(String cgname, long cno, Pageable pageable);
	
	List<ClubGallery> findByCgdescAndClub_cnoContainingOrderByCgnoDesc(String cgdesc, long cno, Pageable pageable);
	
	List<ClubGallery> findByMember_midAndClub_cnoContainingOrderByCgnoDesc(String mid, long cno, Pageable pageable);
