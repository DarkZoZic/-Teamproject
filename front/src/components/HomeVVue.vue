<template>
<div >
<HeaderVVue style="height: 400px;"></HeaderVVue>
    <v-app id="inspire"> 
        <!-- 메인 리스트 -->
        <v-main>
            <div style="padding: 20px;">
                <v-row dense style="padding-top: 10px;">
                    ...
                    <v-col>
                        ...
                        <v-row style="border-top: 1px solid #CCC; margin-top: 40px;"><h2 style="padding: 20px;">슈퍼 클럽</h2></v-row>

                        <v-row dense v-if="state.items1">
                            <v-col v-for="(items, idx) in state.items1" :key="items" cols="4">
                                <v-card style="padding: 10px; margin: 10px;">
                                <v-row dense>
                                    <v-col class="col_center">
                                        <img v-if="items.imgurl" :src="items.imgurl" @click="handlePage(items.obj.cno, idx)" style="border: 2px solid gold; height: 200px; max-width: 300px; cursor: pointer;"/>
                                ...
                                <v-row dense>
                                    ...
                                    <v-col sm="3" class="col_right">
                                        <v-btn style="height: 50px; width: 10px;" id="like"  @click="changeheart(items.obj.cno,idx)">
                                ...
                                <v-row dense>
                                    <v-col>
                                        <h4 @click="handlePage(items.obj.cno, idx)" style="cursor: pointer; color: gray;">{{items.obj.cname}}</h4>
                                    </v-col>
                                </v-row>
...
import HeaderVVue from './HeaderVVue.vue';
import { onMounted, computed } from '@vue/runtime-core';
import axios from 'axios';

export default {
    components: { VueperSlides, VueperSlide, HeaderVVue, FooterVue },
    setup () {
...
.back {
  background: linear-gradient(90deg, rgba(255,215,0,1) 35%, rgba(245,255,0,1) 100%);
}
