<template>
  <v-app>
    <v-main>
      <v-row dense class="back" style="height: 150px; border-bottom:2px solid gold; padding-bottom: 10px; padding-top: 20px; padding-left: 10px;">
        <!-- 좌측상단공란 -->
            <v-col sm="2" >
            ...
            <v-col>
              <v-row dense>
                <v-col class="col_right2" style="padding-right: 30px;">
                  <h3 @click="handleClick('/')" style="cursor: pointer;" class="mar-l_20">홈</h3>
              ...
              <v-row dense class="col_center">
                <v-col sm="1"></v-col>
                <v-col sm="5" style="margin-top: 20px; height: 50px; border: 3px solid gold; border-radius: 4px; padding-left: 10px; background-color: white;">
