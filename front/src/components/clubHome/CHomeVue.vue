        ...
        <v-col sm="8">
          <v-row dense style="padding: 10px;">
            ...
            <v-col sm="6" style="padding: 15px;">
              ...
              <v-row dense style="padding-left: 10px; padding-right: 10px; float: left; margin: 10px;">
                <v-col sm="6" style="padding-right: 10px;" v-for="tmp in state.G.slice(0, 4)" :key="tmp">
                  <v-row dense style="height: 220px; border: 1px solid #CCC;" >
                    <v-col class="col_center" style="height: 220px;" >
                      <img :src="tmp.gimageurl" @click="G(tmp.cgno)" style="cursor: pointer; max-width: 100%; max-height: 100%;" />
                    </v-col>
                  </v-row>
