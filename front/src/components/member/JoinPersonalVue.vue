              ...
              <v-expansion-panel-text style="overflow: scroll; height: 300px;">
                <v-row style="border: 1px solid #CCC;">
                  <v-col>
                    <v-row dense >
                      <v-col>
                        본 약관은 (주)클러버네트웍스(이하 “회사”)가 운영하는 온라인 웹사이트를 통하여 직업정보 관련 제반 “서비스”를 제공함
                ...
                <v-row style="border: 1px solid #CCC;">
                  <v-col>
                    <v-row dense >
                      <v-col>
                        1.수집·이용의 목적<br />
                        -회원의 SMS/MMS을 이용하여 뉴스(맞춤 클럽 포함), 이벤트, 소식, 설문, 광고 정보를 전송<br /><br />
                        2.수집·이용 항목<br />
                        -SMS/MMS<br /><br />
                        3.보유 기한<br />
                ...
                <v-row style="border: 1px solid #CCC;">
                  <v-col>
                    <v-row dense >
                      <v-col>                
                        1.수집·이용의 목적<br />
                        -회원의 이메일을 이용하여 뉴스(맞춤 클럽 포함), 이벤트, 소식, 설문, 광고 정보를 전송<br /><br />
                        2.수집·이용 항목<br />
                        -이메일<br /><br />
                        3.보유 기한<br />
                        -관계 법령의 규정에 따라 보존할 의무가 있는 경우가 아닌 한, 회원탈퇴 또는 동의 철회 시 까지<br /><br />
              ...
              <v-expansion-panel>
                ...
                <v-row dense>
                  <v-col style="width: 100%; height: 165px;" class="col_center">
                    <img :src="state.imageUrl"  style="width: 150px; height: 150px; border: 1px solid #CCC;"/>
                  </v-col>
                </v-row>
