...
import CCUpdateVue       from '@/components/club/CCUpdateVue.vue';
...
const routes = [
    { path: '/home',      name: "HomeVue",           component: HomeVue },
    { path: '/',          name: "HomeVVue",          component: HomeVVue },
    ...
    { path: '/ccupdate',  name: "CCUpdateVue",       component: CCUpdateVue },
